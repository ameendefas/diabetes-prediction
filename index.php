                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-container">
                            <h1><span id="js-rotating">Diabetes Prediction</span></h1>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 text-center text-lg-left text-xl-left">
                    <div class="text-container about">
                        <h4>Developed by:</h4>
                        <h2 class="white">Mohamed Ameen</h2>
                        <p class="white">19MIS0339</p>
                        <p class="white">Vellore Institute Of Technology</p>
