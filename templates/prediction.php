        ...
        <form action="/predict" method="GET">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card" style="background-color:#B40431;">
                        <div class="card-body">
                            <h5 class="card-title" style="color:white;">Pregnancies</h5>

                            <input type="text" name="Pregnancies" id="Pregnancies" placeholder="Enter your Pregnancies" required="required" style="text-align: center;" /><br>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card" style="background-color:#B40431;">
                        <div class="card-body">
                            <h5 class="card-title" style="color:white;">Glucose</h5>

                            <input type="text" name="Glucose" id="Glucose" placeholder="Enter your Glucose" required="required" style="text-align: center;" /><br>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card" style="background-color:#B40431;">
                        <div class="card-body">
                            <h5 class="card-title" style="color:white;">BloodPressure</h5>

                            <input type="text" name="BloodPressure" id="BloodPressure" placeholder="Enter your BloodPressure" required="required" style="text-align: center;" /><br>
                        </div>
                    </div>
                </div>
</div><br>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card" style="background-color:#B40431;">
                        <div class="card-body">
                            <h5 class="card-title" style="color:white;">SkinThickness</h5>

                            <input type="text" name="SkinThickness" id="SkinThickness" placeholder="Enter your SkinThickness" required="required" style="text-align: center;" /><br>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card" style="background-color:#B40431;">
                        <div class="card-body">
                            <h5 class="card-title" style="color:white;">Insulin</h5>

                            <input type="text" name="Insulin" id="Insulin" placeholder="Enter your Insulin" required="required" style="text-align: center;" /><br>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card" style="background-color:#B40431;">
                        <div class="card-body">
                            <h5 class="card-title" style="color:white;">BMI</h5>

                            <input type="text" name="BMI" id="BMI" placeholder="Enter your BMI" required="required" style="text-align: center;" /><br>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card" style="background-color:#B40431;">
                        <div class="card-body">
                            <h5 class="card-title" style="color:white;">DiabetesPedigree</h5>

                            <input type="text" name="DiabetesPedigreeFunction" id="DiabetesPedigreeFunction" placeholder="Enter your DiabetesPedigreeFunction" required="required" style="text-align: center;" /><br>
                        </div>
                    </div>
                </div>
